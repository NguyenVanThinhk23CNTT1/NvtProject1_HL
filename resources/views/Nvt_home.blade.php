    ...
    <header class="fixed-top nvt-navbar border-bottom py-2">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                <button class="btn btn-link text-dark p-0"><span class="material-symbols-outlined">search</span></button>
    ...
    <main style="margin-top: 70px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <button class="btn nvt-btn-primary shadow">Mua ngay</button>
                    </div>
                </div>
            </div>
        </section>

        <!-- Categories Section (Động từ DB) -->
        <section class="py-5 container">
            ...
            <div class="row text-center g-4">
                ...
                <div class="col-md-4 nvt-category-item">
                    <a href="#" class="text-decoration-none text-dark d-block">
                        ...
                        <h4 class="fs-5 fw-bold text-success">{{ $category->CategoryName }}</h4>
                    </a>
                </div>
                @endforeach
            </div>
        ...
        <section class="py-5 bg-white border-top border-bottom">
            <div class="container">
                <div class="d-flex justify-content-between align-items-end mb-4">
                    ...
                    <a href="#" class="text-success text-decoration-none fw-semibold">Xem tất cả &rarr;</a>
                </div>
                        ...
                        <div class="card nvt-product-card h-100 p-3">
                            <div class="position-relative mb-3">
                                <img src="{{ asset('images/' . ($product->Image ?? 'default.jpg')) }}" 
                                     class="card-img-top nvt-product-img" 
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    ...
                                    <button class="nvt-btn-add d-flex align-items-center justify-content-center">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-2">
                    ...
                    <ul class="list-unstyled small">
                        <li><a href="#" class="text-decoration-none text-muted">Sản phẩm</a></li>
                        <li><a href="#" class="text-decoration-none text-muted">Mẹo chăm sóc</a></li>
                    </ul>
                </div>
                <div class="col-md-2">
